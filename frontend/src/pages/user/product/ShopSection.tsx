                                ...
                                <div className="products-grid mt-40">
                                    <div className="row g-4">
                                        ...
                                        <div className="col-lg-4 col-md-6">
                                            <div className="vr5-product-card">
                                                <div className="feature-image position-relative h-300">
                                                    <img src="/assets/user/images/products/chair-md.png" alt="not found" className="img-fluid" />
                                                    <div className="action-box">
                                                        <a href="#" className="cart-btn">Add to Cart</a>
                                                        <div className="action-btns">
                                                            <a href="#">
                                                ...
                                                <div className="product-content">
                                                    <span className="fw-semibold subtitle text-uppercase">Levies Cotton</span>
                                                    <a href="product-details.html"><h6 className="fw-semibold mt-3">Smart Small Chairs</h6></a>
                                                    <p className="fs-sm mb-4">Nam accumsan urna leo fermentum egestas, erat id vehicula at.</p>
                                                    <span className="text-main-color fw-bold fs-sm">$893.00</span>
                                                </div>
                                            </div>
                                        ...
                                        <div className="col-lg-4 col-md-6">
                                            <div className="vr5-product-card">
                                                <div className="feature-image position-relative h-300">
                                                    <img src="/assets/user/images/products/chair-md-3.png" alt="not found" className="img-fluid" />
                                                    <div className="action-box">
                                                        <a href="#" className="cart-btn">Add to Cart</a>
                                                        <div className="action-btns">
                                                            <a href="#">
                                                ...
                                                <div className="product-content">
                                                    <span className="fw-semibold subtitle text-uppercase">Levies Cotton</span>
                                                    <a href="product-details.html"><h6 className="fw-semibold mt-3">White Long Chairs</h6></a>
                                                    <p className="fs-sm mb-4">Nam accumsan urna leo fermentum egestas, erat id vehicula at.</p>
                                                    <span className="text-main-color fw-bold fs-sm">$893.00</span>
                                                </div>
                                            </div>
                                        ...
                                        <div className="col-lg-4 col-md-6">
                                            <div className="vr5-product-card">
                                                ...
                                                <div className="product-content">
                                                    <span className="fw-semibold subtitle text-uppercase">Levies Cotton</span>
                                                    <a href="product-details.html"><h6 className="fw-semibold mt-3">Wooden Short Chairs</h6></a>
                                                    <p className="fs-sm mb-4">Nam accumsan urna leo fermentum egestas, erat id vehicula at.</p>
                                                    <span className="text-main-color fw-bold fs-sm">$893.00</span>
                                                </div>
                                            </div>
                                        ...
                                        <div className="col-lg-4 col-md-6">
                                            <div className="vr5-product-card">
                                                <div className="feature-image position-relative h-300">
                                                    <img src="/assets/user/images/products/chair-pd.png" alt="not found" className="img-fluid" />
                                                    <div className="action-box">
                                                        <a href="#" className="cart-btn">Add to Cart</a>
                                                        <div className="action-btns">
                                                            <a href="#">
                                        ...
                                        <div className="col-lg-4 col-md-6">
                                            <div className="vr5-product-card">
                                                ...
                                                <div className="product-content">
                                                    <span className="fw-semibold subtitle text-uppercase">Levies Cotton</span>
                                                    <a href="product-details.html"><h6 className="fw-semibold mt-3">Smart Office Chair</h6></a>
                                                    <p className="fs-sm mb-4">Nam accumsan urna leo fermentum egestas, erat id vehicula at.</p>
                                                    <span className="text-main-color fw-bold fs-sm">$893.00</span>
                                                </div>
                                            </div>
                                        ...
                                        <div className="col-lg-4 col-md-6">
                                            <div className="vr5-product-card">
                                                ...
                                                <div className="product-content">
                                                    <span className="fw-semibold subtitle text-uppercase">Levies Cotton</span>
                                                    <a href="product-details.html"><h6 className="fw-semibold mt-3">Smart Wooden Tables</h6></a>
                                                    <p className="fs-sm mb-4">Nam accumsan urna leo fermentum egestas, erat id vehicula at.</p>
                                                    <span className="text-main-color fw-bold fs-sm">$893.00</span>
                                                </div>
                                            </div>
                                        ...
                                        <div className="col-lg-4 col-md-6">
                                            <div className="vr5-product-card">
                                                ...
                                                <div className="product-content">
                                                    <span className="fw-semibold subtitle text-uppercase">Levies Cotton</span>
                                                    <a href="product-details.html"><h6 className="fw-semibold mt-3">Short Weardrobe</h6></a>
                                                    <p className="fs-sm mb-4">Nam accumsan urna leo fermentum egestas, erat id vehicula at.</p>
                                                    <span className="text-main-color fw-bold fs-sm">$893.00</span>
                                                </div>
                                            </div>
                                        ...
                                        <div className="col-lg-4 col-md-6">
                                            <div className="vr5-product-card">
                                                ...
                                                <div className="product-content">
                                                    <span className="fw-semibold subtitle text-uppercase">Levies Cotton</span>
                                                    <a href="product-details.html"><h6 className="fw-semibold mt-3">White Long Chair</h6></a>
                                                    <p className="fs-sm mb-4">Nam accumsan urna leo fermentum egestas, erat id vehicula at.</p>
                                                    <span className="text-main-color fw-bold fs-sm">$893.00</span>
                                                </div>
                                            </div>
                                        ...
                                        <div className="col-lg-4 col-md-6">
                                            <div className="vr5-product-card">
                                                ...
                                                <div className="product-content">
                                                    <span className="fw-semibold subtitle text-uppercase">Levies Cotton</span>
                                                    <a href="product-details.html"><h6 className="fw-semibold mt-3">Short Wooden Chair</h6></a>
                                                    <p className="fs-sm mb-4">Nam accumsan urna leo fermentum egestas, erat id vehicula at.</p>
                                                    <span className="text-main-color fw-bold fs-sm">$893.00</span>
                                                </div>
                                            </div>
