								...
								<div className="sidebar-widget color-select-widget mt-60">
									...
									<ul className="color-select">
										<li>
											<label>
												<input type="checkbox" />
												<span className="bg-soft-gold">
													Soft Gold <span>(12)</span>
												</span>
											</label>
										</li>
										<li>
											<label>
												<input type="checkbox" />
												<span className="bg-light-pink">
													Light Pink <span>(05)</span>
												</span>
											</label>
										</li>
										<li>
											<label>
												<input type="checkbox" />
												<span className="bg-green-touch">
													Green Touch <span>(02)</span>
												</span>
											</label>
										</li>
										<li>
											<label>
												<input type="checkbox" />
												<span className="bg-navy-blue">
													Navy Blue <span>(05)</span>
												</span>
											</label>
										</li>
										<li>
											<label>
												<input type="checkbox" />
												<span className="bg-gray-white">
													Gray White <span>(16)</span>
												</span>
											</label>
										</li>
									</ul>
									...
									<ul className="sidebar-products">
										...
										<li className="d-flex align-items-center gap-4">
											<div className="flex-shrink-0 thumbnail light-bg p-3">
												<a href="product-details.html">
													<img
														src="/assets/user/images/products/chair-md-2.png"
														alt="thumbnail"
														className="img-fluid"
													/>
												</a>
										...
										<li className="d-flex align-items-center gap-4">
											<div className="flex-shrink-0 thumbnail light-bg p-3">
												<a href="product-details.html">
													<img
														src="/assets/user/images/products/table-md.png"
														alt="thumbnail"
														className="img-fluid"
													/>
												</a>
