                        ...
                        <div className="col-xl-9 order-1 order-xl-2">
                            <div className="shop-grid">
                                <div className="d-flex align-items-center justify-content-between gap-3 flex-wrap">
                                    <p className="mb-0 fw-light">Showing 1-{products.length} of {products.length} results</p>
                                            ...
                                            <div key={product.id} className="col-lg-4 col-md-6">
                                                <div className="vr5-product-card">
                                                    <div className="feature-image position-relative h-300">
                                                        <img src={product.image || "/assets/user/images/products/chair-md-2.png"} alt={product.name} className="img-fluid" />
                                                    ...
                                                    <div className="product-content">
                                                        <span className="fw-semibold subtitle text-uppercase">{product.category_id ? `Category ${product.category_id}` : 'Uncategorized'}</span>
                                                        <Link to={`/products/${product.id}`}><h6 className="fw-semibold mt-3">{product.name}</h6></Link>
                                                        <p className="fs-sm mb-4">{product.description || 'No description available.'}</p>
                                                        <span className="text-main-color fw-bold fs-sm">{formatCurrency(product.price)}</span>
                                                    </div>
                                                </div>
                                            </div>
                                        ))}
