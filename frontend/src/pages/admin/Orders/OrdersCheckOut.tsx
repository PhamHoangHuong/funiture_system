              ...
              <div className="col-lg-9">
                <div className="row">
                  ...
                  <div className="col-lg-6">
                    <form>
                      <div className="mb-3">
                        <label htmlFor="your-number" className="form-label">Phone number</label>
                ...
                <div className="col-lg-9">
                  <div className="row">
                    <div className="col-lg-12">
                      ...
                      <form>
                        <div className="mb-3">
                          <label htmlFor="your-address" className="form-label">Full Address</label>
                  ...
                  <div className="mt-2">
                    <a href="#!" className="link-primary fw-medium">+ Add New Billing Address</a>
                  </div>
                          ...
                          <div className="d-flex align-items-center p-2 rounded gap-2 border">
                            <div className="d-flex align-items-center gap-2">
                              <div className="rounded-3 bg-light avatar-md d-flex align-items-center justify-content-center">
                                <img src="assets/images/brands/dhl.png"  className="avatar rounded" />
                              </div>
                              <div>
                                ...
                                <p className="mb-0 text-dark">
                                  Delivery -
                                  <span className="text-muted fw-normal">Today</span>
                                </p>
                              </div>
                            </div>
                      ...
                      <div className="form-check form-checkbox-primary ps-0">
                        <label htmlFor="shipping-2" className="w-100">
                          <div className="d-flex align-items-center p-2 rounded gap-2 border">
                            <div className="d-flex align-items-center gap-2">
                              <div className="rounded-3 bg-light avatar-md d-flex align-items-center justify-content-center">
                                <img src="assets/images/brands/fedex.png"  className="avatar rounded" />
                              </div>
                              <div>
                                <h5 className="text-dark fw-medium">
                                  FedEx Services
                      ...
                      <div className="form-check form-checkbox-primary ps-0">
                        <label htmlFor="shipping-3" className="w-100">
                          <div className="d-flex align-items-center p-2 rounded gap-2 border">
                            <div className="d-flex align-items-center gap-2">
                              <div className="rounded-3 bg-light avatar-md d-flex align-items-center justify-content-center">
                                <img src="assets/images/brands/ups.png"  className="avatar rounded" />
                              </div>
                              <div>
                                <h5 className="text-dark fw-medium">
                                  UPS Services
                                ...
                                <p className="mb-0 text-dark">
                                  Delivery -
                                  <span className="text-muted fw-normal">Tomorrow</span>
                                </p>
                              </div>
                            </div>
                            <div className="ms-auto">
                      ...
                      <div className="form-check form-checkbox-primary ps-0">
                        <label htmlFor="shipping-4" className="w-100">
                          <div className="d-flex align-items-center p-2 rounded gap-2 border">
                            <div className="d-flex align-items-center gap-2">
                              <div className="rounded-3 bg-light avatar-md d-flex align-items-center justify-content-center">
                                <Icon icon="solar:box-bold-duotone" className="fs-36 text-warning" />
                              </div>
                              <div>
                                <h5 className="text-dark fw-medium">
                                ...
                                <p className="mb-0 text-dark">
                                  Delivery -
                                  <span className="text-muted fw-normal">25 Apr 2024</span>
                                </p>
                              </div>
                            </div>
                            <div className="ms-auto">
                    ...
                    <div className="accordion" id="accordionExample">
                      <div className="card">
                        <div className="card-header p-0" id="pay-pal">
                          <h2 className="mb-0">
                            <button className="btn btn-light w-100 collapsed rounded-0 border-bottom rounded-top-1" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                              <div className="d-flex align-items-center justify-content-between">
                                <span className="fs-5">Paypal</span>
                                <img src="assets/images/card/paypal.svg"  className="avatar-sm" />
                              </div>
                            </button>
                          </h2>
                        ...
                        <div id="collapseTwo" className="collapse" aria-labelledby="pay-pal" data-bs-parent="#accordionExample">
                          <div className="card-body">
                            ...
                            <button className="btn btn-light w-100 collapsed rounded-0 border-bottom rounded-top-1" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                              <div className="d-flex align-items-center justify-content-between">
                                ...
                                <div className="icons text-end">
                                  ...
                                  <img src="assets/images/card/stripe.svg"  className="avatar-sm" />
                                  <img src="assets/images/card/visa.svg"  className="avatar-sm" />
                                </div>
                              </div>
                            </button>
                          </h2>
                          ...
                          <div className="p-3">
                            ...
                            <div className="row">
                              <div className="col-md-6">
                                <div className="mb-3">
                                  <label htmlFor="ex-date" className="form-label">Expiry Date</label>
                            ...
                            <div className="alert alert-success mb-0 d-flex align-items-center gap-2" role="alert">
                              <Icon icon="solar:shield-check-bold" className="fs-28 align-middle" />
      ...
      <div className="col-lg-4">
        <div className="card text-center bg-primary overflow-hidden z-1">
          <div className="card-body p-4">
            <h4 className="card-title text-white">Have a Promo Code ?</h4>
            ...
            <div className="table-responsive">
              <div className="d-flex align-items-center gap-3 mb-4">
                <div className="rounded bg-light avatar d-flex align-items-center justify-content-center">
                  <img src="assets/images/product/p-1.png"  className="avatar" />
                </div>
                <div>
              ...
              <div className="d-flex align-items-center gap-3 mb-4">
                <div className="rounded bg-light avatar d-flex align-items-center justify-content-center">
                  <img src="assets/images/product/p-5.png"  className="avatar" />
                </div>
                <div>
              ...
              <div className="d-flex align-items-center gap-3 mb-4">
                <div className="rounded bg-light avatar d-flex align-items-center justify-content-center">
                  <img src="assets/images/product/p-8.png"  className="avatar" />
                </div>
                <div>
              ...
              <div className="d-flex align-items-center gap-3 mb-4">
                <div className="rounded bg-light avatar d-flex align-items-center justify-content-center">
                  <img src="assets/images/product/p-10.png"  className="avatar" />
                </div>
                <div>
            ...
            <div className="alert alert-warning alert-icon mt-3 mb-0" role="alert">
              <div className="d-flex align-items-center">
                <div className="avatar-sm rounded bg-warning d-flex justify-content-center align-items-center fs-22 me-2 flex-shrink-0">
                  <Icon icon="solar:kick-scooter-broken" className="align-middle text-white" />
                </div>
        ...
        <div className="main-btn my-4 text-end">
          <a href="order-cart.html" className="btn btn-danger">Back To Cart</a>
          <a href="#!" className="btn btn-success" data-bs-toggle="modal" data-bs-target="#checkoutModal">Checkout Order</a>
        </div>
            ...
            <div className="card-body">
              <div className="d-flex gap-3">
                ...
                <div>
                  ...
                  <p className="text-white-50 mb-0">Below your selected items, enter your zip code to calculate the shipping charge. We like to make shipping simple and affordable!</p>
                </div>
              </div>
              <div className="d-flex align-items-center gap-3 mt-4">
                <div className="rounded-3 bg-light flex-shrink-0 avatar d-flex align-items-center justify-content-center">
                  <Icon icon="solar:wallet-money-bold-duotone" className="fs-36 text-success" />
                </div>
                <div>
            ...
            <div className="card border-0 mb-0">
                  ...
                  <div className="row align-items-center">
                    <div className="col-lg-12">
                      <div className="check-icon text-center">
                        <img src="assets/images/party.png"  className="img-fluid" />
                        <h4 className="fw-semibold mt-3">Thank You !</h4>
                        <p className="mb-1">Your Transaction Was
                          Successful</p>
                        <p><span className="text-dark fw-medium">Order Id</span> : #0758267/90</p>
                      </div>
                      <hr />
                      ...
                      <div className="row justify-content-between mt-3 align-items-center">
                        ...
                        <div className="col-lg-4 col-6 text-end">
                          <img src="assets/images/users/avatar-1.jpg"  className="avatar rounded-circle" />
                        </div>
                      </div>
                      <div className="row justify-content-between mt-3 align-items-center">
                        <div className="col-lg-6 col-6">
                        ...
                        <div className="col-lg-4 col-6 text-end">
                          <span className="text-success fw-semibold">Completed <i className="bx bx-check-circle align-middle" /></span>
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <div data-bs-theme="dark">
                <div className="card-footer d-flex align-items-center border-0 bg-body gap-3 rounded">
                  ...
                  <div className="ms-auto">
                    <a href="#!" className="text-primary fs-30" data-bs-toggle="tooltip" data-bs-title="Download Invoice" data-bs-placement="bottom"><Icon icon="solar:download-square-bold" className="align-middle" /></a>
                  </div>
                </div>
              </div>
            </div>
